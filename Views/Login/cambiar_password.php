              ...
              <div class="card card-plain mt-sm-8 mt-7 mt-md-5">
                <div class="card-header pb-0 text-left">
                  <h3 class="font-weight-bolder text-primary text-gradient">
                    <center>FORTALEZA</center>
                  </h3>
                  <p class="mb-0">Restablecer la contraseña</p>
                </div>


                <div class="card-body pb-3" id="formReset"> 
                  <form role="form" name="formCambiarPass" id="formCambiarPass">
                    ...
                    <div class="mb-3">
                      <input id="txtPassword" name="txtPassword" type="password" class="form-control" placeholder="Nueva contraseña" aria-label="Email">
                    </div>                                        
                    <div class="mb-3">
                      <input id="txtPasswordConfirm" name="txtPasswordConfirm" type="password" class="form-control" placeholder="Confirmar contraseña" aria-label="Email">
                    </div>
                    <div class="text-center">
                      <button type="submit" class="btn bg-gradient-primary w-100 mt-4 mb-0">ENVIAR</button>
                    </div>
                  </form>

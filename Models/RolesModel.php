<?php 
	...
	class RolesModel extends Mysql
	{
		...
		public function selectRol(int $idrol){
			//Le asignamos a la propiedad el valor que trae la función
        $this->intIdrol=$idrol;
		...
		public function insertRol(string $rol,string $descripcicion,int $status){
           $return ="";
		   $this->strRol=$rol;
		...
		public function updateRol(int $idrol, string $rol,string $descripcicion,int $status){
			$this->intIdrol=$idrol;
			$this->strRol=$rol;
			$this->strDescripcion=$descripcicion;
			$this->intStatus=$status;
